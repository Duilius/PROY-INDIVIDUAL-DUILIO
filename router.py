...
from fastapi import APIRouter, Response         #Permite dividir las rutas de la app
...
@user.get("/")
def root():
    return "Hola, soy DUILIO RESTUCCIA. Para probar mi trabajo debes adicionar a la url '/api/pregN' (donde N =[1,2,3,4]) Ejm: 'https://35c5-190-234-57-194.sa.ngrok.io/api/preg4' "
